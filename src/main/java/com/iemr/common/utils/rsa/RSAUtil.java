...
public class RSAUtil {
    ...
    public static String encryptUserDetails(String encryptedString) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException
    {
